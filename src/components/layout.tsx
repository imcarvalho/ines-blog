...
export default function Layout(props: {
  ...
  const links = [
    {
      href: `https://github.com/${props.siteMetadata.social.github}/`,
      label: 'GitHub',
      svg: (
        <LinkIconStyle
          role="img"
    ...
    {
      href: `https://twitter.com/${props.siteMetadata.social.twitter}`,
      label: 'Twitter',
      svg: (
        <LinkIconStyle
          role="img"
    ...
    {
      href: `https://www.linkedin.com/in/${props.siteMetadata.social.linkedin}/`,
      label: 'LinkedIn',
      svg: (
        <LinkIconStyle
          role="img"
    ...
    <>
      ...
      <HeaderStyle isLanding={isLanding}>
        ...
        <TextContainerStyle isLanding={isLanding}>
          ...
          <LinkListStyle>
            {links.map(link => (
              <LinkListItemStyle isLanding={isLanding} key={link.label}>
                <RegularLinkStyle
                  href={link.href}
                  target="_blank"
            ...
            <LinkListItemStyle isLanding={isLanding}>
